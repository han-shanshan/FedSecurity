...
class FedDefender:
    ...
    @staticmethod
    def get_instance():
        if FedDefender._defender_instance is None:
            FedDefender._defender_instance = FedDefender()

        return FedDefender._defender_instance
    ...
    def init(self, args):
        ...
        if (
            ...
            logging.info(
                "FedDefender is not supported for the machine learning engine: %s. "
